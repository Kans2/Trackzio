...
export default function Navbar() {
  ...
  const { mode, toggleTheme, collections, currentUser } = useAppContext();
  ...
  const totalItems = Object.values(collections).reduce((acc, curr) => acc + curr.length, 0);

  return (
    <AppBar position="sticky" color="inherit" elevation={1}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <AutoAwesomeMosaicIcon sx={{ display: { xs: 'none', md: 'flex' }, mr: 1, color: 'primary.main' }} />
          <Typography
            variant="h6"
            noWrap
            component={NavLink}
          ...
          <AutoAwesomeMosaicIcon sx={{ display: { xs: 'flex', md: 'none' }, mr: 1, color: 'primary.main' }} />
          <Typography
            variant="h5"
            noWrap
            component={NavLink}
